...
class _HealthScoreCardState extends State<_HealthScoreCard>
  ...
  void initState() {
    ...
    _progress = Tween<double>(begin: 0, end: _score)
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
            colors: [Color(0xFF0D1B35), Color(0xFF112240)]),
        borderRadius: BorderRadius.circular(20),
        border: Border.all(color: AppTheme.cardBorder),
        boxShadow: [
          BoxShadow(color: AppTheme.accent.withOpacity(0.08), blurRadius: 24)
        ],
      ),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Your vitals look great! Maintain your healthy lifestyle.',
            style: Theme.of(context).textTheme.bodyMedium),
      ]),
    );
  }
...
class _RiskFactorsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final factors = [
      ('Age', 0.2, AppTheme.accentGreen),
      ('Pulse Rate', 0.35, AppTheme.accentGreen),
      ('Oxygen Level', 0.15, AppTheme.accentGreen),
      ('Activity', 0.45, Color(0xFFFFD700)),
    ];
    return Container(
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
